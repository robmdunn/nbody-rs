...
const NBodySimulationFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_nbodysimulation_free(ptr >>> 0, 1));
...
export class NBodySimulation {
    ...
    constructor(canvas, config) {
        _assertClass(config, SimConfig);
        const ret = wasm.nbodysimulation_new(canvas, config.__wbg_ptr);
        if (ret[2]) {
    ...
    render() {
        wasm.nbodysimulation_render(this.__wbg_ptr);
    }
    /**
     * @param {number} x
     * @param {number} y
    ...
    handle_mouse_down(x, y) {
        wasm.nbodysimulation_handle_mouse_down(this.__wbg_ptr, x, y);
    }
    /**
     * @param {number} dx
     * @param {number} dy
    ...
    handle_mouse_move(dx, dy) {
        wasm.nbodysimulation_handle_mouse_move(this.__wbg_ptr, dx, dy);
    }
    /**
     * @param {number} delta_y
     */
    handle_scroll(delta_y) {
        wasm.nbodysimulation_handle_scroll(this.__wbg_ptr, delta_y);
    }
    /**
     * @param {boolean} show_wireframe
     */
    set_wireframe(show_wireframe) {
        wasm.nbodysimulation_set_wireframe(this.__wbg_ptr, show_wireframe);
    }
}

const SimConfigFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_simconfig_free(ptr >>> 0, 1));
...
export class SimConfig {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SimConfigFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_simconfig_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    get n_bodies() {
        const ret = wasm.__wbg_get_simconfig_n_bodies(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} arg0
     */
    set n_bodies(arg0) {
        wasm.__wbg_set_simconfig_n_bodies(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get mass() {
        const ret = wasm.__wbg_get_simconfig_mass(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set mass(arg0) {
        wasm.__wbg_set_simconfig_mass(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get g() {
        const ret = wasm.__wbg_get_simconfig_g(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set g(arg0) {
        wasm.__wbg_set_simconfig_g(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get timestep() {
        const ret = wasm.__wbg_get_simconfig_timestep(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set timestep(arg0) {
        wasm.__wbg_set_simconfig_timestep(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get softening() {
        const ret = wasm.__wbg_get_simconfig_softening(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set softening(arg0) {
        wasm.__wbg_set_simconfig_softening(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get spin() {
        const ret = wasm.__wbg_get_simconfig_spin(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set spin(arg0) {
        wasm.__wbg_set_simconfig_spin(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get mzero() {
        const ret = wasm.__wbg_get_simconfig_mzero(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set mzero(arg0) {
        wasm.__wbg_set_simconfig_mzero(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get tree_ratio() {
        const ret = wasm.__wbg_get_simconfig_tree_ratio(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set tree_ratio(arg0) {
        wasm.__wbg_set_simconfig_tree_ratio(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get point_size() {
        const ret = wasm.__wbg_get_simconfig_point_size(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set point_size(arg0) {
        wasm.__wbg_set_simconfig_point_size(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {boolean}
     */
    get fixed_scale() {
        const ret = wasm.__wbg_get_simconfig_fixed_scale(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {boolean} arg0
     */
    set fixed_scale(arg0) {
        wasm.__wbg_set_simconfig_fixed_scale(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {boolean}
     */
    get mode_3d() {
        const ret = wasm.__wbg_get_simconfig_mode_3d(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {boolean} arg0
     */
    set mode_3d(arg0) {
        wasm.__wbg_set_simconfig_mode_3d(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {boolean}
     */
    get show_wireframe() {
        const ret = wasm.__wbg_get_simconfig_show_wireframe(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @param {boolean} arg0
     */
    set show_wireframe(arg0) {
        wasm.__wbg_set_simconfig_show_wireframe(this.__wbg_ptr, arg0);
    }
    constructor() {
        const ret = wasm.simconfig_new();
        this.__wbg_ptr = ret >>> 0;
        SimConfigFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_lineWidth_f18c99c2246f6236 = function(arg0, arg1) {
        arg0.lineWidth(arg1);
    };
